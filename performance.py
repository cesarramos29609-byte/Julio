...
def record_performance(action, status="exitoso"):
    ...
    """
    # Using time.strftime is ~5-6x faster than datetime.datetime.now().strftime
    timestamp = time.strftime("%Y-%m-%d %H:%M:%S")
    # Optimizing message construction by including newline and avoiding redundant concatenation
    message = (
    ...
    # Reuse optimized message for console, stripping the trailing newline for cleaner print
