...
def record_performance(action, status="exitoso"):
    """
    Records a performance action with a persistent file handle for better efficiency.
    """
    ...
    with _log_lock:
        try:
            ...
            # In case the handle was invalidated or file system issues, try to re-open once
            global _log_file_handle
            _log_file_handle = None
            handle = _get_log_handle()
            handle.write(message + "\n")
