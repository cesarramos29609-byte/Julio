class AuditProtocol:
    ...
    def __init__(self):
        self.logs = []
        # Performance optimization: track verified logs inline to avoid O(N) scans on get_audit_summary
    ...
    def get_audit_summary(self):
        """
        Returns a summary of audits.
        Optimized to use self._verified_count in O(1) time complexity.
        """
        total = len(self.logs)
